    ...
    <style>
        ...
        * {
        ...
        .match-score {
            ...
            border:
                6px solid rgba(0,198,255,.20);

            background: white;

            box-shadow:
                0 8px 25px rgba(10,46,107,.08);
        }
